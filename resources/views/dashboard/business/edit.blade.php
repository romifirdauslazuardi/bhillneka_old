...
<div class="row">
    <div class="col-sm-12">
        ...
        <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Edit Bisnis</li>
        </ul>
    </div>
</div>
@endsection
...
<div class="row">
    <div class="col-12 mt-4">
        <div class="card border-0 rounded shadow p-4">
            <form action="{{route('dashboard.business.update',$result->id)}}" id="frmUpdate" autocomplete="off">
                @csrf
                @method("PUT")
                <div class="row mb-3">
                    <div class="col-lg-12">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-9">
                                <select class="form-control select2" name="category_id" >
                                    ...
                                    <option value="{{$row->id}}" @if($row->id == old('category_id',$result->category_id)) selected @endif>{{$row->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-9">
                                <textarea class="form-control" name="location" rows="5" placeholder="Alamat Lengkap">{{old('location',$result->location)}}</textarea>
                            </div>
                        </div>
                        <div class="form-group row mb-3">
...
<script>
    $(function(){
        ...
        @if(!empty($result->village_code))
            ...
            getVillage('.select-village','{{$result->village->district->code ?? null}}','{{$result->village_code}}');
        @else
