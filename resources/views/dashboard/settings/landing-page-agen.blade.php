    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Pengaturan Landing Page Agen</li>
            </ul>
        </div>
    </div>
@endsection
...
<div class="row">
    <div class="col-12 mt-4">
        <div class="card border-0 rounded shadow p-4">
            <form action="{{route('dashboard.settings.landing-page-agen.update')}}" id="frmUpdate" autocomplete="off">
                @csrf
                @method("PUT")
                <div class="row mb-3">
                    <div class="col-lg-12">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-9">
                                ...
                                <div class="mb-2">
                                    <img src="{{asset($result?->logo_dark)}}" style="width: 100px;height: 100px;">
                                </div>
                                @endif
                ...
                $.ajax({
                    ...
                    success : function(resp){
                        if(resp.success == false){
                            ...
                            responseSuccess(resp.message,"{{route('dashboard.settings.landing-page-agen.index')}}");
                        }
                    },
