...
<div class="row">
    <div class="col-12 mt-4">
        <div class="card border-0 rounded shadow p-4">
            <form action="{{route('dashboard.settings.customer-fee.store')}}" id="frmStore" autocomplete="off">
                @csrf
                <div class="row mb-3">
                    <div class="col-lg-12">
                        ...
                        <div class="form-group row mb-2">
                            ...
                            <div class="col-md-4 mb-1mb-1">
                                <input type="text" class="form-control" name="value" placeholder="Nilai" value="{{old('value')}}">
                            </div>
                        </div>
                    </div>
                </div>
