...
<div class="d-md-flex justify-content-between align-items-center">
    ...
    <nav aria-label="breadcrumb" class="d-inline-block mt-2 mt-sm-0">
        <ul class="breadcrumb bg-transparent rounded mb-0 p-0">
            <li class="breadcrumb-item text-capitalize"><a href="#">Meja</a></li>
            <li class="breadcrumb-item text-capitalize active" aria-current="page">Daftar Meja</li>
        </ul>
    </nav>
</div>
@endsection
        ...
        <div class="card border-0 rounded shadow p-4">
            <div class="row mb-3">
                <div class="col-lg-12">
                    ...
                    <a href="{{route('dashboard.tables.create')}}" class="btn btn-primary btn-sm btn-add"><i class="fa fa-plus"></i> Tambah</a>
                    @endif
                    <a href="#" class="btn btn-success btn-sm btn-filter"><i class="fa fa-filter"></i> Filter</a>
                    <a href="{{route('dashboard.tables.index')}}" class="btn @if(!empty(request()->all())) btn-warning @else btn-secondary @endif btn-sm"><i class="fa fa-refresh"></i> Refresh</a>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                                        ...
                                        <td>
                                            <div class="dropdown-primary me-2 mt-2">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a href="{{route('dashboard.tables.edit',$row->id)}}" class="dropdown-item btn-edit"><i class="fa fa-edit"></i> Edit</a>
    ...
    $(function() {
        ...
        $(document).on("click", ".btn-delete", function() {
            ...
            if (confirm("Apakah anda yakin ingin menghapus data ini ?")) {
                $("#frmDelete").attr("action", "{{ route('dashboard.tables.destroy', '_id_') }}".replace("_id_", id));
