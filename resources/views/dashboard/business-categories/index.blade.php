        ...
        <div class="card border-0 rounded shadow p-4">
            <div class="row mb-3">
                <div class="col-lg-12">
                    ...
                    <a href="{{route('dashboard.business-categories.index')}}" class="btn btn-warning btn-sm"><i class="fa fa-refresh"></i> Refresh</a>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
...
<script>
    $(function() {
        ...
        $(document).on("click", ".btn-edit", function(e) {
            ...
            $("#frmUpdate").attr("action", "{{ route('dashboard.business-categories.update', '_id_') }}".replace("_id_", id));
        ...
        $(document).on("click", ".btn-delete", function() {
            ...
            if (confirm("Apakah anda yakin ingin menghapus data ini ?")) {
                $("#frmDelete").attr("action", "{{ route('dashboard.business-categories.destroy', '_id_') }}".replace("_id_", id));
                ...
                $.ajax({
                    ...
                    success : function(resp){
                        if(resp.success == false){
                            ...
                            responseSuccess(resp.message,"{{route('dashboard.business-categories.index')}}");
                        }
                    },
