    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Show Rekening Pengguna</li>
            </ul>
        </div>
    </div>
@endsection
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="alert alert-warning" role="alert">
                                Halo owner , bisnis page sedang diaktifkan , halaman rekening akan tampil sesuai rekening
                                bisnis page yang sedang aktif . Nonaktifkan bisnis page jika ingin menambahkan/menampilkan
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-md-8">
                                    : <span
                                        class="badge bg-{{ $result->status()->class ?? null }}">{{ $result->status()->msg ?? null }}</span>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="d-flex justify-content-start mt-3">
                                <a href="{{ route('dashboard.user-banks.index') }}" class="btn btn-warning btn-sm"
                                    style="margin-right: 10px;"><i class="fa fa-arrow-left"></i> Kembali</a>
                                <a href="{{ route('dashboard.user-banks.edit', $result->id) }}"
        ...
        $(function() {
            $(document).on("click", ".btn-delete", function() {
                ...
                if (confirm("Apakah anda yakin ingin menghapus data ini ?")) {
                    $("#frmDelete").attr("action", "{{ route('dashboard.user-banks.destroy', '_id_') }}"
                        .replace("_id_", id));
