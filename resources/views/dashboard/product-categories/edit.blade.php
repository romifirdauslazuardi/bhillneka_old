    ...
    <div class="row">
        <div class="col-12 mt-4">
            <div class="card border-0 rounded shadow p-4">
                <form action="{{ route('dashboard.product-categories.update', $result->id) }}" id="frmUpdate"
                    autocomplete="off">
                    @csrf
                    @method('PUT')
                    <div class="row mb-3">
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <input name="name" placeholder="Category Name" value="{{ $result->name }}" type="text"
                                    class="form-control">
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="image-upload">
                                    <input type="file" name="image"
                                        style="{{ $result->image != null ? 'height: 300px;' : '' }}">
                                    <div class="image-uploads">
                                        <img src="{{ asset($result->image != null ? $result->image : 'assets/dreampos/assets/img/icons/upload.svg') }}"
                                            alt="img" style="max-height: 226px;">
