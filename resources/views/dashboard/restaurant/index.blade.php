                ...
                <div class="row">
                    <div class="col-12">
                        <ul class="nav nav-tabs nav-tabs-solid">
                            ...
                            <li class="nav-item"><a class="nav-link" href="#solid-tab2" data-bs-toggle="tab">About Us</a>
                            </li>
                            <li class="nav-item"><a class="nav-link" href="#solid-tab3" data-bs-toggle="tab">Testimoni</a>
                            </li>
                        </ul>
                        <div class="tab-content px-3 py-5">
                            ...
                            <div class="tab-pane" id="solid-tab2">
                                <form action="{{ route($routeAbout) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        {!! $formAbout !!}
                                    </div>
                            ...
                            <div class="tab-pane" id="solid-tab3">
                                <form action="{{ route($routeTestimoni) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div>
                                            <button type="button" class="btn btn-cancel btn-sm" id="hideForm"
                                                onclick="hideShowForm('#testimoni')">Hide Form</button>
                                            <button type="button" class="btn btn-cancel bg-danger btn-sm"
                                                onclick="hapus_field('{{ url(route($routeTestimoni)) }}','#testimoni')">Reset
                                                Form</button>
                                        </div>
                                    </div>
                                </form>
                                                ...
                                                @foreach ($dataTestimoni as $item)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex justify-content-center align-items-center">
                                                                <button class="btn btn-primary mx-1" type="button"
                                                                    onclick="edit('{{ url(route($routeTestimoni)) . '/' . $item->id }}', '#testimoni');">
                                                                    <i class="fas fa-pencil-alt"></i>
                                                                </button>
                                                                <form method="POST"
                                                                    action="{{ url(route($routeTestimoni)) . '/' . $item->id }}"
                                                                    class="d-inline delete-confirm">
                                                                    @csrf
                                                                    <input type="hidden" name="_method" value="DELETE">
                                                                    <button class="btn btn-danger mx-1">
