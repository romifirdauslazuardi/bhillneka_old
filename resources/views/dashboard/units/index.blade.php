...
<div class="d-md-flex justify-content-between align-items-center">
    ...
    <nav aria-label="breadcrumb" class="d-inline-block mt-2 mt-sm-0">
        <ul class="breadcrumb bg-transparent rounded mb-0 p-0">
            <li class="breadcrumb-item text-capitalize"><a href="#">Unit</a></li>
        ...
        <div class="card border-0 rounded shadow p-4">
            <div class="row mb-3">
                <div class="col-lg-12">
                    ...
                    <a href="{{route('dashboard.units.index')}}" class="btn @if(!empty(request()->all())) btn-warning @else btn-secondary @endif btn-sm"><i class="fa fa-refresh"></i> Refresh</a>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
...
@include("dashboard.units.modal.index")
...
<script>
    $(function() {
        ...
        $(document).on("click", ".btn-edit", function(e) {
            ...
            $("#frmUpdate").attr("action", "{{ route('dashboard.units.update', '_id_') }}".replace("_id_", id));
        ...
        $(document).on("click", ".btn-delete", function() {
            ...
            if (confirm("Apakah anda yakin ingin menghapus data ini ?")) {
                $("#frmDelete").attr("action", "{{ route('dashboard.units.destroy', '_id_') }}".replace("_id_", id));
                ...
                $.ajax({
                    ...
                    success : function(resp){
                        if(resp.success == false){
                            ...
                            responseSuccess(resp.message,"{{route('dashboard.units.index')}}");
                        }
                    },
