...
if (in_array($result->business->category->name ?? null, [\App\Enums\BusinessCategoryEnum::BARANG])) {
    ...
    $label = ' Jasa';
} elseif (in_array($result->business->category->name ?? null, [\App\Enums\BusinessCategoryEnum::FNB])) {
    $label = ' Produk FNB';
        ...
        <div class="col-12 mt-4">
            <div class="card border-0 rounded shadow p-4">
                <form action="{{ route('dashboard.products.update', $result->id) }}" id="frmUpdate" autocomplete="off">
                                ...
                                <div class="row mb-3">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="form-group row mb-3">
                                            ...
                                            <div class="col-md-9">
                                                <input type="hidden" name="category_id" value="{{ old('category_id', $result->category_id) }}">
                                                <select class="select select2 select-category-id">
                                                    <option disabled>Choose Category</option>
                                                    @foreach ($category as $item)
                                                        <option value="{{ $item->id }}" {{ $item->id == $result->category_id ? 'selected' : '' }}>{{ $item->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                                ...
                                                <div class="col-md-9">
                                                    <select class="form-control select2 select-mikrotik-config"
                                                        ...
                                                        @foreach ($mikrotik_configs as $index => $row)
                                                            <option value="{{ $row->id }}"
                                                                @if ($row->id == $result->mikrotik_config_id) selected @endif>
                                                                {{ $row->name }} - {{ $row->ip }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-md-9">
                                                    <select class="form-control select2 select-mikrotik" name="mikrotik"
                                                        ...
                                                        @foreach ($mikrotik as $index => $row)
                                                            <option value="{{ $index }}"
                                                                @if ($index == $result->mikrotik) selected @endif>
                                                                {{ $row }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-group">
                                                        <input type="number" class="form-control" placeholder="Berat"
                                                            name="weight" value="{{ old('weight', $result->weight) }}">
                                            ...
                                            <div class="col-md-9">
                                                <select class="form-control select2" name="status">
                                                    ...
                                                    @foreach ($status as $index => $row)
                                                        <option value="{{ $index }}"
                                                            @if ($index == $result->status) selected @endif>
                                                            {{ $row }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            ...
                                            <div class="col-md-9">
                                                <select class="form-control select2" name="is_using_stock">
                                                    ...
                                                    @foreach ($is_using_stock as $index => $row)
                                                        <option value="{{ $index }}"
                                                            @if ($index == $result->is_using_stock) selected @endif>
                                                            {{ $row }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                        ...
                        @if (in_array(Auth::user()->business->category->name ?? null, [\App\Enums\BusinessCategoryEnum::MIKROTIK]))
                            <div class="tab-pane fade" id="configuration">
                                <div class="row mt-3">
                                    <div class="col-12">
                                        <div
                                            class="form-group row mb-3 @if (!in_array($result->mikrotik, [\App\Enums\ProductEnum::MIKROTIK_PPPOE])) d-none @endif display-service">
                                            <label class="col-md-3 col-form-label">Service</label>
                                            <div class="col-md-9">
                                                <select class="form-control service select-service" style="width:100%"
                                                    name="service">
                                        ...
                                        <div
                                            class="form-group row mb-3 @if (!in_array($result->mikrotik, [\App\Enums\ProductEnum::MIKROTIK_HOTSPOT])) d-none @endif   display-server">
                                            <label class="col-md-3 col-form-label">Server</label>
                                            <div class="col-md-9">
                                                <select class="form-control server select-server" style="width:100%"
                                                    name="server">
                                        ...
                                        <div
                                            class="form-group row mb-3 @if (!in_array($result->mikrotik, [\App\Enums\ProductEnum::MIKROTIK_PPPOE, \App\Enums\ProductEnum::MIKROTIK_HOTSPOT])) d-none @endif  display-profile">
                                            <label class="col-md-3 col-form-label">Profile</label>
                                            <div class="col-md-9">
                                                <select class="form-control profile select-profile" style="width:100%"
                                                    name="profile">
                                        ...
                                        <div
                                            class="form-group row mb-3 @if (!in_array($result->mikrotik, [\App\Enums\ProductEnum::MIKROTIK_HOTSPOT])) d-none @endif display-address">
                                            <label class="col-md-3 col-form-label">Address</label>
                                            <div class="col-md-9">
                                                <input type="text" class="form-control address" name="address"
                                                    placeholder="Address" value="{{ $result->address }}">
                                            </div>
                                        </div>
                                        <div
                                            class="form-group row mb-3 @if (!in_array($result->mikrotik, [\App\Enums\ProductEnum::MIKROTIK_HOTSPOT])) d-none @endif display-mac-address">
                                            <label class="col-md-3 col-form-label">Mac Address</label>
                                            <div class="col-md-9">
                                                <input type="text" class="form-control mac-address" name="mac_address"
                                                    placeholder="Mac Address" value="{{ $result->mac_address }}">
                                            </div>
                                        </div>
                                        <div
                                            class="form-group row mb-3 @if (!in_array($result->mikrotik, [\App\Enums\ProductEnum::MIKROTIK_HOTSPOT])) d-none @endif display-time-limit">
                                            <label class="col-md-3 col-form-label">Time Limit</label>
                                            <div class="col-md-9">
                                                <input type="text" class="form-control time-limit" name="time_limit"
                                                    placeholder="Contoh : 1d4h30m20s" value="{{ $result->time_limit }}">
                                            </div>
                                        </div>
                                        <div
                                            class="form-group row mb-3 @if (!in_array($result->mikrotik, [\App\Enums\ProductEnum::MIKROTIK_PPPOE])) d-none @endif display-local-address">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" class="form-control local-address"
                                                    ...
                                                    value="{{ $result->local_address }}">
                                            </div>
                                        </div>
                                        <div
                                            class="form-group row mb-3 @if (!in_array($result->mikrotik, [\App\Enums\ProductEnum::MIKROTIK_PPPOE])) d-none @endif display-remote-address">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" class="form-control remote-address"
                                                    ...
                                                    value="{{ $result->remote_address }}">
                                            </div>
                                        </div>
                                        <div
                                            class="form-group row mb-3 @if (!in_array($result->mikrotik, [\App\Enums\ProductEnum::MIKROTIK_PPPOE])) d-none @endif display-month">
                                            <label class="col-md-3 col-form-label">Berlaku Hingga</label>
                                            <div class="col-md-9">
                                                <div class="input-group">
                                                    <input type="number" class="form-control"
                                                        placeholder="Berlaku Hingga" name="expired_month"
                                                        value="{{ $result->expired_month }}">
                                                    <div class="input-group-append">
                                        ...
                                        <div
                                            class="form-group row mb-3 @if (!in_array($result->mikrotik, [\App\Enums\ProductEnum::MIKROTIK_PPPOE, \App\Enums\ProductEnum::MIKROTIK_HOTSPOT])) d-none @endif display-comment">
                                            <label class="col-md-3 col-form-label">Comment</label>
                                            <div class="col-md-9">
                                                <input type="text" class="form-control comment" name="comment"
                                                    placeholder="Comment" value="{{ $result->comment }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <a href="{{ route('dashboard.products.index') }}" class="btn btn-warning btn-sm"><i
    ...
    <script>
        $(function() {
            ...
            @if (in_array($result->mikrotik, [\App\Enums\ProductEnum::MIKROTIK_HOTSPOT]))
                ...
                getProfileHotspot(".select-profile", '{{ $result->mikrotik_config_id }}',
                    '{{ $result->profile }}');
            @endif
