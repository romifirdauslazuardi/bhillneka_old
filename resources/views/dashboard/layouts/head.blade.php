...
<link rel="shortcut icon"
    href="{{ !empty(\SettingHelper::settings('dashboard', 'favicon')) ? asset(\SettingHelper::settings('dashboard', 'favicon')) : URL::to('/') . '/templates/dashboard/assets/images/favicon.ico' }}" />
<!-- Css -->
...
<!-- animation CSS -->
<link rel="stylesheet" href="{{ asset('assets/dreampos/assets/css/animate.css') }}">

<!-- Datatable CSS -->
<link rel="stylesheet" href="{{ asset('assets/dreampos/assets/css/dataTables.bootstrap4.min.css') }}">
