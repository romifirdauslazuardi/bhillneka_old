            ...
            <form method="get" action="" autocomplete="off">
                <div class="modal-body">
                    <div class="form-group mb-3">
                        <label>Search</label>
                        <input type="text" class="form-control" placeholder="Search (Pertanyaan,Jawaban)" value="{{request()->get('search')}}" name="search">
                    </div>
                </div>
...
<div class="modal fade" id="modalStore" aria-labelledby="modalStore-title" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content rounded shadow border-0">
            <div class="modal-header border-bottom">
                <h5 class="modal-title" id="modalStore-title">Tambah Faq</h5>
                <button type="button" class="btn btn-icon btn-close" data-bs-dismiss="modal" id="close-modal"><i class="uil uil-times fs-4 text-dark"></i></button>
            </div>
            <form method="POST" action="{{route('dashboard.landing-page.faqs.store')}}" id="frmStore" autocomplete="off">
                @csrf
                <div class="modal-body">
                    <div class="form-group mb-3">
                        <label>Pertanyaan <span class="text-danger">*</span></i></label>
                        <input type="text" class="form-control" placeholder="Pertanyaan" name="question">
                    </div>
                    <div class="form-group mb-3">
                        <label>Jawaban <span class="text-danger">*</span></i></label>
...
<div class="modal fade" id="modalUpdate" aria-labelledby="modalUpdate-title" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content rounded shadow border-0">
            <div class="modal-header border-bottom">
                <h5 class="modal-title" id="modalUpdate-title">Edit Faq</h5>
                <button type="button" class="btn btn-icon btn-close" data-bs-dismiss="modal" id="close-modal"><i class="uil uil-times fs-4 text-dark"></i></button>
            </div>
