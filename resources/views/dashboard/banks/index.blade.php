        ...
        <div class="card border-0 rounded shadow p-4">
            <div class="row mb-3">
                <div class="col-lg-12">
                    ...
                    <a href="{{route('dashboard.banks.index')}}" class="btn btn-warning btn-sm"><i class="fa fa-refresh"></i> Refresh</a>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                ...
                $.ajax({
                    ...
                    success : function(resp){
                        if(resp.success == false){
                            ...
                            responseSuccess(resp.message,"{{route('dashboard.banks.index')}}");
                        }
                    },
