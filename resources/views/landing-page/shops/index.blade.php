    ...
    @section('content')
        <div class="row">
            <div class="col-12 col-lg-8">
                <div class="row mb-3">
                    <div class="col-sm-12">
                        <h3 class="page-title">Katalog</h3>
                        <ul class="breadcrumb">
                ...
                @foreach ($product_category as $index => $category)
                    <div class="prd_section row row-cols-1 row-cols-md-4 mt-4 {{ $index != 0 ? 'd-none' : '' }}" id="prdctg{{ $category->id }}">
                        @if ($category->products->count() > 0)
                            @foreach ($category->products as $product)
                                <div class="product_card mb-4 position-relative"
