    ...
    function slider() {
        ...
        sld_args.slide.forEach(function (vvv, iii) {
            ...
            if (n > 1) {
                ...
                var delay = li;
                setTimeout(function () {
                    document.querySelector('#titleHeader').innerText = sld_args.title[iii];
                    document.querySelector('#captionHeader').innerText = sld_args.caption[iii];
                    // console.log(sld_args.caption[iii])
