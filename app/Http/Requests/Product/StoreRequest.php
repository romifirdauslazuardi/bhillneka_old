...
class StoreRequest extends FormRequest
{
    public function prepareForValidation()
    {
        ...
        if (in_array(Auth::user()->business->category->name, [BusinessCategoryEnum::JASA, BusinessCategoryEnum::BARANG, BusinessCategoryEnum::FURNITURE, BusinessCategoryEnum::FNB, BusinessCategoryEnum::ELECTRONIC, BusinessCategoryEnum::HOTEL, BusinessCategoryEnum::RESTAURANT])) {
